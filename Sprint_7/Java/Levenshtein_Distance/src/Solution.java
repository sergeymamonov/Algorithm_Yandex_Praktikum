...
//          - итерации по каждому символу 1 строки, O(N), где N - длина первой строки,
//          - итерации по каждому символу 2 строки, O(M), где M - длина второй строки,
//          - определения минимума из трех величин, O(1).
//      Итоговая временная сложность будет составлять O(N * M).
//
